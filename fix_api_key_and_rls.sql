-- ========================================
-- COMPREHENSIVE API KEY & RLS FIX SCRIPT
-- ========================================
...
SELECT 
    ...
    hasinsert as "Can Insert",
    hasselect as "Can Select",
    hasupdate as "Can Update",
    hasdelete as "Can Delete"
FROM pg_tables 
...
-- Step 10: Test query (this should work after the fix)
SELECT COUNT(*) as "Total Users in Database" FROM public.users;

-- Step 11: Show sample user data (limit 3 for security)
